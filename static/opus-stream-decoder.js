...
Module['print'] = typeof console !== 'undefined'
  ? console.log.bind (console)
  : typeof print !== 'undefined' ? print : null;
Module['printErr'] = typeof printErr !== 'undefined'
  ? printErr
...
function integrateWasmJS () {
  var wasmTextFile = 'opus-stream-decoder.wast';
  var wasmBinaryFile = 'opus-stream-decoder.wasm';
  var asmjsCodeFile = 'opus-stream-decoder.temp.asm.js';
...
STATICTOP = STATIC_BASE + 38208;
__ATINIT__.push ();
var STATIC_BUMP = 38208;
...
var _opus_chunkdecoder_create = (Module[
  '_opus_chunkdecoder_create'
] = function () {
  return Module['asm']['_opus_chunkdecoder_create'].apply (null, arguments);
});
var _opus_chunkdecoder_decode_float_stereo_deinterleaved = (Module[
...
var _opus_chunkdecoder_enqueue = (Module[
  '_opus_chunkdecoder_enqueue'
] = function () {
  return Module['asm']['_opus_chunkdecoder_enqueue'].apply (null, arguments);
});
var _opus_chunkdecoder_free = (Module['_opus_chunkdecoder_free'] = function () {
  return Module['asm']['_opus_chunkdecoder_free'].apply (null, arguments);
});
var _opus_chunkdecoder_version = (Module[
  '_opus_chunkdecoder_version'
] = function () {
  return Module['asm']['_opus_chunkdecoder_version'].apply (null, arguments);
});
var _opus_get_version_string = (Module[
  '_opus_get_version_string'
] = function () {
  return Module['asm']['_opus_get_version_string'].apply (null, arguments);
});
...
OpusStreamDecoder.prototype.ready = new Promise (function (resolve, reject) {
  addOnPreMain (function () {
    var api = {
      ...
      enqueue: cwrap ('opus_chunkdecoder_enqueue', null, [
        'number',
        'number',
        'number',
      ]),
      decode: cwrap (
        'opus_chunkdecoder_decode_float_stereo_deinterleaved',
        'number',
...
OpusStreamDecoder.prototype.decode = function (uint8array) {
  ...
  try {
    ...
    [decodedInterleavedPtr, decodedInterleavedArry] = this.createOutputArray (
      decodedPcmSize
    );
    ...
    while (sendStart < srcLen) {
      ...
      while (
        (samplesDecoded = this.api.decode (
...
// module.exports = OpusStreamDecoder